...
- `impute("model",posit_y,posit_x)` - impute data under characteristics form object like a optional grouping or weighting variable
- `impute_N("model",posit_y,posit_x,times)` - multiple imputations - impute data under characteristics form object like a optional grouping or weighting variable - works for ("lm_bayes","lm_noise")
