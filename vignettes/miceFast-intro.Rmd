...
- is_vars_updated() - is any variable at the object modified by impute with a force parameter set to TRUE
...
#implementing lm_pred
pred =  model$impute("lm_pred",posit_y,posit_x[-length(posit_x)])
