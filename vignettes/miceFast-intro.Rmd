...
as.vector(model$vifs(c(2,3,4,5,6,7)))
```
...
- `vifs(posit_y,posit_x)` - Variance inflation factors (VIF) - helps to check when the predictor variables are not linearly related. 
